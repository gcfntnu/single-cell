...
parser.add_argument('--sample-info', help='samplesheet filename', default=None)
...
parser.add_argument('--var-names', help='variable (gene) identifiers', default='gene_ids', choices=['gene_ids', 'gene_symbols'])
